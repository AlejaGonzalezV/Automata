 ...
 * Clase encargada de calcular el autómata mínimo equivalente cuando este es Moore
 */
public class Moore {
	...
	/**
	 * Método constructor de la clase Moore
	 */
	public Moore() {
	...
	/**
	 * Método get del atributo str2
	 * @return Arreglo con los arreglos que contienen los nombres de los estados existentes en el autómata
	 */
	...
	/**
	 * Método set del atributo estados
	 * @param str2 Arreglo con todos los arreglos que contienen los nombres de los estados existentes en el autómata
	 */
